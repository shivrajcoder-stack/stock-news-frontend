                ...
                return (
                  <div key={index} className={`news-card ${sentiment}`} data-testid={`news-card-${index}`}>
                    ...
                    <div className="micro-tags">
                      ...
                      { Object.keys(facts).length > 0 && <span className="micro-tag">Data</span> }
                      ...
                      { Array.isArray(item.mentioned_companies) && item.mentioned_companies.length > 0 && <span className="micro-tag">Mentions</span> }
                    </div>
