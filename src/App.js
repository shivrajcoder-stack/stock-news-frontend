...
// ----------------------------------------------------------------------
const BACKEND_BASE_URL = process.env.REACT_APP_BACKEND_URL || "https://stock-news-backend-e3h7.onrender.com";

// Ensures that whether the environment variable is set or not, 
// the final API endpoint always correctly points to the '/api' prefix 
// which is required by your server.py's FastAPI router.
